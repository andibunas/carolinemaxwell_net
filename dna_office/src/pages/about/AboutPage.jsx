  ...
  return (
    <div className="mx-auto max-w-2xl px-6 sm:px-8 py-12">
      ...
      <div className="text-ink-soft leading-relaxed space-y-4 text-sm">
        <p>
          <strong className="text-ink">Caroline Maxwell</strong> received her MFA degree in Studio Practice from
        ...
        <p>
          <strong className="text-ink">Tal Yizrael</strong> is an experimental photographer and installation artist.
